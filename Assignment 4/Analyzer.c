...
//Does your Text IO
//
//prompts you for a file path and repeats until file path is valid
//
//It will initialize memory for you!
//
//Prints debugging information!
//
//Autograder will check this output
//
//Assumes null - terminated lexemes
